...
public final class Render3DEvent {
    ...
    public static final class Renderer {
        ...
        public void line(double x1, double y1, double z1,
            ...
            int argb = color.argb();
            vertices.vertex(pose, ax, ay, az).color(argb).normal(pose, nx, ny, nz);
            vertices.vertex(pose, bx, by, bz).color(argb).normal(pose, nx, ny, nz);
        }
        ...
        private static void vertex(VertexConsumer vertices, MatrixStack.Entry pose,
            ...
            vertices.vertex(pose, x, y, z).color(color);
        }
